...
def falsa_posicion_metodo(f, a, b, tol, max_iter):
    x = sp.symbols('x')
    ...
    while iteracion < max_iter:
        ...
        if abs(fb_cur - fa_cur) < 1e-15:
            raise ValueError(f"f(b) - f(a) ≈ 0 en la iteración {iteracion}. El método no puede continuar.")
    ...
    return f"Final de iteraciones alcanzado, raíz aproximada: {c}", resultados
